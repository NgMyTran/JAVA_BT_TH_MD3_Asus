...
import session14.test.phuong_thuc_thuc_dinh.IColorable;
import session14.test.phuong_thuc_thuc_dinh.Color;
import session14.test.phuong_thuc_thuc_dinh.Shape;
