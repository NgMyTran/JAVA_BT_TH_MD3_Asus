...
import session15.bussiness.CategoryBusiness;
import session15.bussiness.ICategoriesDesign;
import session15.util.InputMethods;

import java.io.Serializable;

import static session15.bussiness.CategoryBusiness.categories;
...
public class Product implements IManagement, Serializable {
    ...
    private String getCategoryName() {
        ICategoriesDesign categoryDesign = new CategoryBusiness();
